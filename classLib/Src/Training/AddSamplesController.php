...
use CAPTCHA_Reader\Cutting\CuttingController;
use CAPTCHA_Reader\Distinguish\Identify\IdentifyTrait;
use CAPTCHA_Reader\GetImageInfo\GetImageInfoController;
use CAPTCHA_Reader\Identify\IdentifyController;
use CAPTCHA_Reader\Pretreatment\PretreatmentController;

class AddSamplesController
{
    use CommonTrait,IdentifyTrait;
    private $config;
    private $charArr;
    /**
    ...
    /**
     * AddSamplesController constructor.
     * @param $mode
     */
